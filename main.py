...
class LitStoringModel(thunderstorm.ThunderModule):
...
for _ in range(5):
    for i in range(2, 10, 2):
        for layer in range(5):
            ...
            cmc = thunderstorm.callbacks.ConfusionMatrixCallback()
            hpc = thunderstorm.callbacks.hyper_param.HyperparametersCallback()
